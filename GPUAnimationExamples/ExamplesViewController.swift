...
class ExamplesViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    let dTapGR = UITapGestureRecognizer(target: self, action: #selector(doubleTap))
//    tapGR.require(toFail: dTapGR)
  ...
  func pan(_ gr:LZPanGestureRecognizer){
    square.animate{
      ...
      $0.type = .Spring(stiffness: 700, damping: 25, threshold: nil)
